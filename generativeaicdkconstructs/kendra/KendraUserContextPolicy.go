...
const (
	...
	// Experimental.
	KendraUserContextPolicy_ATTRIBUTE_FILTER KendraUserContextPolicy = "ATTRIBUTE_FILTER"
	...
	// Experimental.
	KendraUserContextPolicy_USER_TOKEN KendraUserContextPolicy = "USER_TOKEN"
)
