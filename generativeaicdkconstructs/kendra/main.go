...
func init() {
	...
	_jsii_.RegisterEnum(
		"@cdklabs/generative-ai-cdk-constructs.kendra.KendraEdition",
		reflect.TypeOf((*KendraEdition)(nil)).Elem(),
		map[string]interface{}{
			"DEVELOPER_EDITION": KendraEdition_DEVELOPER_EDITION,
			"ENTERPRISE_EDITION": KendraEdition_ENTERPRISE_EDITION,
			"GEN_AI_ENTERPRISE_EDITION": KendraEdition_GEN_AI_ENTERPRISE_EDITION,
		},
	)
	...
	_jsii_.RegisterEnum(
		"@cdklabs/generative-ai-cdk-constructs.kendra.KendraIndexFieldTypes",
		reflect.TypeOf((*KendraIndexFieldTypes)(nil)).Elem(),
		map[string]interface{}{
			"STRING": KendraIndexFieldTypes_STRING,
			"STRING_LIST": KendraIndexFieldTypes_STRING_LIST,
			"LONG": KendraIndexFieldTypes_LONG,
			"DATE": KendraIndexFieldTypes_DATE,
		},
	)
	_jsii_.RegisterEnum(
		"@cdklabs/generative-ai-cdk-constructs.kendra.KendraUserContextPolicy",
		reflect.TypeOf((*KendraUserContextPolicy)(nil)).Elem(),
		map[string]interface{}{
			"ATTRIBUTE_FILTER": KendraUserContextPolicy_ATTRIBUTE_FILTER,
			"USER_TOKEN": KendraUserContextPolicy_USER_TOKEN,
		},
	)
}
