...
func validateVectorCollection_FromCollectionAttributesParameters(constructScope constructs.Construct, constructId *string, attrs *VectorCollectionAttributes) error {
	if constructScope == nil {
		return fmt.Errorf("parameter constructScope is required, but nil was provided")
	}

	if constructId == nil {
		return fmt.Errorf("parameter constructId is required, but nil was provided")
	}
