...
func (b *jsiiProxy_BedrockDataAutomation) validateAddObservabilityToConstructParameters(props *generativeaicdkconstructs.BaseClassProps) error {
	return nil
}

func (b *jsiiProxy_BedrockDataAutomation) validateUpdateConstructUsageMetricCodeParameters(props *generativeaicdkconstructs.BaseClassProps, scope constructs.Construct, lambdaFunctions *[]awslambda.DockerImageFunction) error {
	return nil
}

func (b *jsiiProxy_BedrockDataAutomation) validateUpdateEnvSuffixParameters(props *generativeaicdkconstructs.BaseClassProps) error {
	return nil
}
