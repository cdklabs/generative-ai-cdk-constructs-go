...
func (j *jsiiProxy_DataSource) DataSourceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dataSourceId",
...
func (j *jsiiProxy_DataSource) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_DataSource) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_DataSource) Stack() awscdk.Stack {
...
func DataSource_FromDataSourceId(scope constructs.Construct, id *string, dataSourceId *string) IDataSource {
	...
	if err := validateDataSource_FromDataSourceIdParameters(scope, id, dataSourceId); err != nil {
		panic(err)
	}
	...
	_jsii_.StaticInvoke(
		...
		"fromDataSourceId",
		[]interface{}{scope, id, dataSourceId},
		&returns,
	)
...
func DataSource_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateDataSource_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func DataSource_IsResource(construct constructs.IConstruct) *bool {
	...
	if err := validateDataSource_IsResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataSource) ApplyRemovalPolicy(policy awscdk.RemovalPolicy) {
...
func (d *jsiiProxy_DataSource) GeneratePhysicalName() *string {
	var returns *string
...
func (d *jsiiProxy_DataSource) GetResourceArnAttribute(arnAttr *string, arnComponents *awscdk.ArnComponents) *string {
...
func (d *jsiiProxy_DataSource) GetResourceNameAttribute(nameAttr *string) *string {
