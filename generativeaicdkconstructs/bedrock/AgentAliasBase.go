...
// The jsii proxy struct for AgentAliasBase
type jsiiProxy_AgentAliasBase struct {
	internal.Type__awscdkResource
	jsiiProxy_IAgentAlias
}

func (j *jsiiProxy_AgentAliasBase) Agent() IAgent {
	var returns IAgent
	_jsii_.Get(
		j,
		"agent",
...
func (j *jsiiProxy_AgentAliasBase) AliasArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"aliasArn",
...
func (j *jsiiProxy_AgentAliasBase) AliasId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"aliasId",
...
func (j *jsiiProxy_AgentAliasBase) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_AgentAliasBase) Node() constructs.Node {
...
func (j *jsiiProxy_AgentAliasBase) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_AgentAliasBase) Stack() awscdk.Stack {
...
func AgentAliasBase_IsConstruct(x interface{}) *bool {
	...
	if err := validateAgentAliasBase_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func AgentAliasBase_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateAgentAliasBase_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func AgentAliasBase_IsResource(construct constructs.IConstruct) *bool {
	...
	if err := validateAgentAliasBase_IsResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_AgentAliasBase) ApplyRemovalPolicy(policy awscdk.RemovalPolicy) {
...
func (a *jsiiProxy_AgentAliasBase) GeneratePhysicalName() *string {
	var returns *string
...
func (a *jsiiProxy_AgentAliasBase) GetResourceArnAttribute(arnAttr *string, arnComponents *awscdk.ArnComponents) *string {
...
func (a *jsiiProxy_AgentAliasBase) GetResourceNameAttribute(nameAttr *string) *string {
...
func (a *jsiiProxy_AgentAliasBase) Grant(grantee awsiam.IGrantable, actions ...*string) awsiam.Grant {
...
func (a *jsiiProxy_AgentAliasBase) GrantInvoke(grantee awsiam.IGrantable) awsiam.Grant {
...
func (a *jsiiProxy_AgentAliasBase) OnCloudTrailEvent(id *string, options *awsevents.OnEventOptions) awsevents.Rule {
...
func (a *jsiiProxy_AgentAliasBase) ToString() *string {
	var returns *string
