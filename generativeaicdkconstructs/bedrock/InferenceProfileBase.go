...
// The jsii proxy struct for InferenceProfileBase
type jsiiProxy_InferenceProfileBase struct {
	internal.Type__awscdkResource
	jsiiProxy_IInferenceProfile
	internal.Type__awscdkIResource
}

func (j *jsiiProxy_InferenceProfileBase) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_InferenceProfileBase) InferenceProfileArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"inferenceProfileArn",
...
func (j *jsiiProxy_InferenceProfileBase) InferenceProfileId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"inferenceProfileId",
...
func (j *jsiiProxy_InferenceProfileBase) Node() constructs.Node {
...
func (j *jsiiProxy_InferenceProfileBase) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_InferenceProfileBase) Stack() awscdk.Stack {
...
func (j *jsiiProxy_InferenceProfileBase) Type() InferenceProfileType {
...
func InferenceProfileBase_IsConstruct(x interface{}) *bool {
	...
	if err := validateInferenceProfileBase_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func InferenceProfileBase_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateInferenceProfileBase_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func InferenceProfileBase_IsResource(construct constructs.IConstruct) *bool {
	...
	if err := validateInferenceProfileBase_IsResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func (i *jsiiProxy_InferenceProfileBase) GeneratePhysicalName() *string {
	var returns *string
...
func (i *jsiiProxy_InferenceProfileBase) GetResourceArnAttribute(arnAttr *string, arnComponents *awscdk.ArnComponents) *string {
...
func (i *jsiiProxy_InferenceProfileBase) GetResourceNameAttribute(nameAttr *string) *string {
...
func (i *jsiiProxy_InferenceProfileBase) GrantProfileUsage(grantee awsiam.IGrantable) awsiam.Grant {
...
func (i *jsiiProxy_InferenceProfileBase) ToString() *string {
	var returns *string
