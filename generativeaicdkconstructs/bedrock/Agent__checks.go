...
func (a *jsiiProxy_Agent) validateAddAgentCollaboratorParameters(agentCollaborator AgentCollaborator) error {
	if agentCollaborator == nil {
		return fmt.Errorf("parameter agentCollaborator is required, but nil was provided")
	}
