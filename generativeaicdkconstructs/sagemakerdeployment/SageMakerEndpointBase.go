...
func (s *jsiiProxy_SageMakerEndpointBase) AddObservabilityToConstruct(props *generativeaicdkconstructs.BaseClassProps) {
...
func (s *jsiiProxy_SageMakerEndpointBase) UpdateConstructUsageMetricCode(props *generativeaicdkconstructs.BaseClassProps, scope constructs.Construct, lambdaFunctions *[]awslambda.DockerImageFunction) {
...
func (s *jsiiProxy_SageMakerEndpointBase) UpdateEnvSuffix(props *generativeaicdkconstructs.BaseClassProps) {
