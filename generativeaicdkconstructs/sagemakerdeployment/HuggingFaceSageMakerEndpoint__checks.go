...
func (h *jsiiProxy_HuggingFaceSageMakerEndpoint) validateAddObservabilityToConstructParameters(props *generativeaicdkconstructs.BaseClassProps) error {
	if props == nil {
...
func (h *jsiiProxy_HuggingFaceSageMakerEndpoint) validateUpdateConstructUsageMetricCodeParameters(props *generativeaicdkconstructs.BaseClassProps, scope constructs.Construct, lambdaFunctions *[]awslambda.DockerImageFunction) error {
	if props == nil {
		return fmt.Errorf("parameter props is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(props, func() string { return "parameter props" }); err != nil {
...
func (h *jsiiProxy_HuggingFaceSageMakerEndpoint) validateUpdateEnvSuffixParameters(props *generativeaicdkconstructs.BaseClassProps) error {
	if props == nil {
		return fmt.Errorf("parameter props is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(props, func() string { return "parameter props" }); err != nil {
