...
func (c *jsiiProxy_CustomSageMakerEndpoint) AddObservabilityToConstruct(props *generativeaicdkconstructs.BaseClassProps) {
...
func (c *jsiiProxy_CustomSageMakerEndpoint) UpdateConstructUsageMetricCode(props *generativeaicdkconstructs.BaseClassProps, scope constructs.Construct, lambdaFunctions *[]awslambda.DockerImageFunction) {
...
func (c *jsiiProxy_CustomSageMakerEndpoint) UpdateEnvSuffix(props *generativeaicdkconstructs.BaseClassProps) {
