...
func (s *jsiiProxy_SageMakerEndpointBase) validateAddObservabilityToConstructParameters(props *generativeaicdkconstructs.BaseClassProps) error {
	return nil
}

func (s *jsiiProxy_SageMakerEndpointBase) validateUpdateConstructUsageMetricCodeParameters(props *generativeaicdkconstructs.BaseClassProps, scope constructs.Construct, lambdaFunctions *[]awslambda.DockerImageFunction) error {
	return nil
}

func (s *jsiiProxy_SageMakerEndpointBase) validateUpdateEnvSuffixParameters(props *generativeaicdkconstructs.BaseClassProps) error {
	return nil
}
