...
func (b *jsiiProxy_BedrockDataAutomation) validateAddObservabilityToConstructParameters(props *generative-ai-cdk-constructs.BaseClassProps) error {
	return nil
}

func (b *jsiiProxy_BedrockDataAutomation) validateUpdateConstructUsageMetricCodeParameters(props *generative-ai-cdk-constructs.BaseClassProps, scope constructs.Construct, lambdaFunctions *[]awslambda.DockerImageFunction) error {
	return nil
}

func (b *jsiiProxy_BedrockDataAutomation) validateUpdateEnvSuffixParameters(props *generative-ai-cdk-constructs.BaseClassProps) error {
	return nil
}
