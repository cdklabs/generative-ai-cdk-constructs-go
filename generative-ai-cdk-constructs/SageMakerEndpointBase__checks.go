...
func (s *jsiiProxy_SageMakerEndpointBase) validateAddObservabilityToConstructParameters(props *BaseClassProps) error {
	if props == nil {
...
func (s *jsiiProxy_SageMakerEndpointBase) validateUpdateConstructUsageMetricCodeParameters(props *BaseClassProps, scope constructs.Construct, lambdaFunctions *[]awslambda.DockerImageFunction) error {
	if props == nil {
		return fmt.Errorf("parameter props is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(props, func() string { return "parameter props" }); err != nil {
...
func (s *jsiiProxy_SageMakerEndpointBase) validateUpdateEnvSuffixParameters(props *BaseClassProps) error {
	if props == nil {
		return fmt.Errorf("parameter props is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(props, func() string { return "parameter props" }); err != nil {
