...
func (h *jsiiProxy_HuggingFaceSageMakerEndpoint) AddObservabilityToConstruct(props *BaseClassProps) {
...
func (h *jsiiProxy_HuggingFaceSageMakerEndpoint) UpdateConstructUsageMetricCode(props *BaseClassProps, scope constructs.Construct, lambdaFunctions *[]awslambda.DockerImageFunction) {
...
func (h *jsiiProxy_HuggingFaceSageMakerEndpoint) UpdateEnvSuffix(props *BaseClassProps) {
