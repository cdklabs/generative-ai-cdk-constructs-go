...
func (c *jsiiProxy_CustomSageMakerEndpoint) AddObservabilityToConstruct(props *generative-ai-cdk-constructs.BaseClassProps) {
...
func (c *jsiiProxy_CustomSageMakerEndpoint) UpdateConstructUsageMetricCode(props *generative-ai-cdk-constructs.BaseClassProps, scope constructs.Construct, lambdaFunctions *[]awslambda.DockerImageFunction) {
...
func (c *jsiiProxy_CustomSageMakerEndpoint) UpdateEnvSuffix(props *generative-ai-cdk-constructs.BaseClassProps) {
