...
func (c *jsiiProxy_CustomSageMakerEndpoint) validateAddObservabilityToConstructParameters(props *generative-ai-cdk-constructs.BaseClassProps) error {
	return nil
}
...
func (c *jsiiProxy_CustomSageMakerEndpoint) validateUpdateConstructUsageMetricCodeParameters(props *generative-ai-cdk-constructs.BaseClassProps, scope constructs.Construct, lambdaFunctions *[]awslambda.DockerImageFunction) error {
	return nil
}

func (c *jsiiProxy_CustomSageMakerEndpoint) validateUpdateEnvSuffixParameters(props *generative-ai-cdk-constructs.BaseClassProps) error {
	return nil
}
