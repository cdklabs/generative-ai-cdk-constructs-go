...
func (j *jsiiProxy_JumpStartSageMakerEndpoint) validateAddObservabilityToConstructParameters(props *generative-ai-cdk-constructs.BaseClassProps) error {
	return nil
}
...
func (j *jsiiProxy_JumpStartSageMakerEndpoint) validateUpdateConstructUsageMetricCodeParameters(props *generative-ai-cdk-constructs.BaseClassProps, scope constructs.Construct, lambdaFunctions *[]awslambda.DockerImageFunction) error {
	return nil
}

func (j *jsiiProxy_JumpStartSageMakerEndpoint) validateUpdateEnvSuffixParameters(props *generative-ai-cdk-constructs.BaseClassProps) error {
	return nil
}
