...
func (h *jsiiProxy_HuggingFaceSageMakerEndpoint) AddObservabilityToConstruct(props *generative-ai-cdk-constructs.BaseClassProps) {
...
func (h *jsiiProxy_HuggingFaceSageMakerEndpoint) UpdateConstructUsageMetricCode(props *generative-ai-cdk-constructs.BaseClassProps, scope constructs.Construct, lambdaFunctions *[]awslambda.DockerImageFunction) {
...
func (h *jsiiProxy_HuggingFaceSageMakerEndpoint) UpdateEnvSuffix(props *generative-ai-cdk-constructs.BaseClassProps) {
