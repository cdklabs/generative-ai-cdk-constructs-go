...
func (s *jsiiProxy_SageMakerEndpointBase) AddObservabilityToConstruct(props *BaseClassProps) {
...
func (s *jsiiProxy_SageMakerEndpointBase) UpdateConstructUsageMetricCode(props *BaseClassProps, scope constructs.Construct, lambdaFunctions *[]awslambda.DockerImageFunction) {
...
func (s *jsiiProxy_SageMakerEndpointBase) UpdateEnvSuffix(props *BaseClassProps) {
