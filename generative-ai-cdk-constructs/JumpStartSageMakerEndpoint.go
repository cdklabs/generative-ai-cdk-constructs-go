...
func (j *jsiiProxy_JumpStartSageMakerEndpoint) AddObservabilityToConstruct(props *BaseClassProps) {
...
func (j *jsiiProxy_JumpStartSageMakerEndpoint) UpdateConstructUsageMetricCode(props *BaseClassProps, scope constructs.Construct, lambdaFunctions *[]awslambda.DockerImageFunction) {
...
func (j *jsiiProxy_JumpStartSageMakerEndpoint) UpdateEnvSuffix(props *BaseClassProps) {
